...
//            capabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, xmlTest.getParameter(AndroidMobileCapabilityType.APP_ACTIVITY));
    ...
    private Map<String, String> defaultAndroidParameters() {
        ...
        parameters.put(AndroidMobileCapabilityType.APP_PACKAGE, "org.schabi.newpipe.debug");
        parameters.put(MobileCapabilityType.APP, "org_schabi_newpipe_debug.apk");
    ...
    private Map<String, String> defaultIosParameters() {
        ...
        parameters.put(MobileCapabilityType.DEVICE_NAME, "iPhone 8");
        parameters.put(MobileCapabilityType.PLATFORM_VERSION, "12.4");
        parameters.put(MobileCapabilityType.AUTOMATION_NAME, "XCUITest");
        parameters.put(MobileCapabilityType.APP, "staging_jp.co.lc.karadakawarunavi.staging_v4.3.9.ipa");
        parameters.put("server", "http://127.0.0.1:4723/wd/hub");
        return parameters;
    }
}
