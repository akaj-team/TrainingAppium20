def sendMessage(module, proFile) {
    ...
    if (report.features.failedFeature == 0) {
        buildStatus = "success"
        colorCode = '#00FF00'
        duration = "- Duration: ${report.durations.totalDuration}, Features: ${report.features.totalFeatures}, Device: ${properties.deviceName}, Platform: ${properties.platformName}, ProjectName: Knavi"
    } else {
        buildStatus = "failed"
        colorCode = '#FF0000'
